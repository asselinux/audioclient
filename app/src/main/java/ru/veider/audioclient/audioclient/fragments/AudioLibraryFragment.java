...
import ru.veider.audioclient.audioclient.fragments.dummy.DummyContent;
...
public class AudioLibraryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new AudioLibraryRecyclerViewAdapter(DummyContent.ITEMS, mListener));
        }
        return view;
    }
